...
?>
	...
	<div class="sect1">
	  	<div class="row">
		    ...
		    <div class="col-lg-4 col-md-6 order-sm-1 order-md-1 order-1 order-lg-0">
		    	<div class="d-flex flex-column align-items-sm-center align-items-lg-start align-items-md-start">
					...
					<div class="el2">
					 	...
					 	<span>Customer Service : <?php the_field('tel_number') ?></span></p>
					</div>
				 	<form class="el3">
		    ...
		    <div class="d-flex col-lg-3 col-md-12 justify-content-center align-items-center">
				<img src="<?php the_field('logo_header') ?>"></div>
		    ...
		    <div class="col-lg-5 col-md-6 order-md-1 order-sm-1 order-1">
		    	<div class="d-flex flex-column align-items-sm-center align-items-lg-end align-items-md-end">
			      	<div class="row justify-content-end">
			      		<div class="r_el1">
				    		<div class="col"><img src="<?php echo get_template_directory_uri();?>/img/wishlist icon.png" id="wishlist_icon"><?php the_field('text_head_1_r') ?>4</div>
				    	</div>
				    	<div class="r_el2">
			    			<div class="col"><img src="<?php echo get_template_directory_uri();?>/img/cart icon.png" id="cart_icon"><?php the_field('text_head_2_r') ?>: <span style="color:#cd222a; font-weight: bold;">$ 345.00</span></div>
			    		</div>
			    	</div>
	    		...
	    		<div class="d-flex flex-sm-column flex-lg-row flex-xl-row align-items-sm-center  align-items-md-end align-items-lg-end align-items-xl-end justify-content-xl-end justify-content-lg-end">
		    		<div class="col-auto" style="padding: 0 0;">
						<button id="btn_1"><img src="<?php echo get_template_directory_uri();?>/img/plus icon copy.png"><?php the_field('btn_head_1_r') ?> </button>
		    		</div>
		    		<div class="col-auto" style="padding: 0 0;">
						<button id="btn_2"><img src="<?php echo get_template_directory_uri();?>/img/checkout icon.png"><?php the_field('btn_head_2_r') ?> </button>
		    		</div>
				</div>	
